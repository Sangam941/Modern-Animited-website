...
const Footer = () => {
    return (
        <div className='w-full h-screen px-14 py-7 font-["Roboto_Condensed"] flex'>
            <div className='w-1/2 h-full flex justify-between flex-col'>
                <div className='leading-[6vw] text-[7vw] font-semibold uppercase tracking-tighter'>
                    <h1 className=''>eye-</h1>
                    <h1 className=''>opening</h1>
                </div>
            ...
            <div className='w-1/2 h-full flex flex-col justify-between'>
                <div>
                    <h1 className='leading-[6vw] text-[7vw] font-semibold uppercase tracking-tighter'>presentations</h1>
                </div>
                <div className='flex flex-col justify-between gap-10'>
                    <div>
                        <h3 className="heading pb-3">S:</h3>
                        {["Instagram", "Behance", "Facebook", "Linkedin"].map((item, index) => {
                            return <div><a key={index}>{item}</a></div>
                        })}
                    </div>
                    <div className='flex justify-between'>
                        <div className='flex flex-col gap-10'>
                            <div>
                                <h3 className="heading pb-3">L:</h3>
                                {["202-1965 W 4th Ave", "Vancouver, Canada", "30 Chukarina St", "Lviv, Ukraine"].map((item, index) => {
                                    return <div><a key={index}>{item}</a></div>
                                })}
                            </div>
                            <div>
                                <h3 className="heading pb-3">E:</h3>
                                <div><a>hello@ochi.design</a></div>
                            </div>
                        </div>

                        <div className=''>
                            <h3 className="heading pb-3">M:</h3>
                ...
                <div>&copy; ochi design 2025. Legal Terms</div>
            </div>
        </div >
    )
}
